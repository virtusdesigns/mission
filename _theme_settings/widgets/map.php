...
// ----------------------------------------------------
class ThemeWidgetMapWidget extends ThemeWidgetBase {
	/*
	* Register widget function. Must have the same name as the class
	*/
	function ThemeWidgetMapWidget() {
		$widget_opts = array(
			'classname' => 'theme-widget-map-widget', // class of the <li> holder
			'description' => __( 'Displays a Google Map.','forgiven') );
		...
		$this->WP_Widget('theme-widget-map-widget', __('Google Map Widget','forgiven'), $widget_opts, $control_ops);
		$this->custom_fields = array(
			array(
				'name'=>'title',
				'type'=>'text',
				'title'=>__('Title (optional)','forgiven'), 
				'default'=> ''
			),
			array(
				'name'=>'map_code',
				'type'=>'textarea',
				'title'=>__('Map &lt;iframe&gt; Code','forgiven'), 
