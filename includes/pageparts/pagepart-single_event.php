					...
					?><article id="event-countdown" class="single-event-block">
						...
						<div class="event-info">
							...
							<div class="event-content<?php if (has_post_thumbnail($e->ID)): echo ' with-img'; endif; ?>">
								...
								<p><?php echo ($e->post_excerpt ? $e->post_excerpt : forgivenTruncate($e->post_content,155).' ...'); ?></p>
								<a class="es-button" href="<?php echo tribe_get_event_link($e->ID); ?>"><?php _e('Event Information','forgiven'); ?></a>
							</div>
						</div>
